...
<div style='text-align:center'>
    <h1 style='color:brown;'>Industrial Copper Modeling Application</h1>
</div>
...
with tab1:
      ...
      # Define the widgets for user input
        ...
        if submit_button and flag==0:
            ...
            with open(r"E:/Industiral copper/Data's/model.pkl", 'rb') as file:
...
with tab2: 
        ...
        if csubmit_button and cflag==0:
            import pickle
            with open(r"E:/Industiral copper/Data's/cmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open(r"E:/Industiral copper/Data's/cscaler.pkl", 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open(r"E:/Industiral copper/Data's/ct.pkl", 'rb') as f:
...
with tab3:
    ...
    st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by GOWRI SHANKAR M</h6>', unsafe_allow_html=True )  
    st.write('The copper industry faces challenges in predicting selling prices and lead classification. However, by utilizing advanced techniques such as data normalization, outlier detection and handling, and using tree-based models such as the decision tree algorithm, we can provide accurate predictions and optimize pricing decisions and leads classification')
    Social_Media={
